...
export const catalogCategories: CatalogCategory[] = [
  {
    ...
    defaultUnit: "л",
    products: [
      { id: "lemonades-1", name: "Щавель", price: 400, image: productImage("щавель.JPG") },
      { id: "lemonades-2", name: "Ананас-гранат", price: 500, image: productImage("ананасгранат.JPG") },
      { id: "lemonades-3", name: "Малина-маракуйя", price: 550, image: productImage("малинамаракуйя.JPG") },
      { id: "lemonades-4", name: "Манго-маракуйя", price: 550, image: productImage("мангомаракуйя.JPG") },
      { id: "lemonades-5", name: "Киви-клубника", price: 500, image: sticker("кивиклубникасъемки") },
      { id: "lemonades-6", name: "Айва-грейпфрут", price: 550, image: productImage("айвагрейпфрут.jpg") },
      { id: "lemonades-7", name: "Цитрус", price: 420, image: productImage("цитрус.JPG") },
      { id: "lemonades-8", name: "Гранат", price: 550, image: productImage("гранат.JPG") },
      { id: "lemonades-9", name: "Вишня-гранат", price: 500, image: productImage("вишнягранат.JPG") },
      { id: "lemonades-10", name: "Щавель ПП", price: 650, image: productImage("щавельпремикс.JPG") },
      { id: "lemonades-11", name: "Мохито классический", price: 500, image: productImage("мохитоклассика.JPG") },
      { id: "lemonades-12", name: "Апероль", price: 750, image: fallback },
      { id: "lemonades-13", name: "Мята-абрикос", price: 550, image: fallback },
  ...
  },
  {
    ...
    defaultUnit: "л",
    products: [
      { id: "teas-1", name: "Малина-имбирь", price: 500, image: productImage("малинаимбирь.JPG") },
      { id: "teas-2", name: "Ягодный", price: 470, image: productImage("ягодамалина.jpg") },
      { id: "teas-3", name: "Смородина-розмарин", price: 500, image: productImage("смородинаразмарин.JPG") },
      { id: "teas-4", name: "Облепиховый", price: 500, image: sticker("облепихасъемки") },
      { id: "teas-5", name: "Имбирный", price: 400, image: sticker("имбирныйсъемки") },
      { id: "teas-6", name: "Марокканский", price: 500, image: productImage("марроканский.jpg") },
      { id: "teas-7", name: "Шиповник-темьян", price: 500, image: productImage("шиповни-темьян.jpg") },
      { id: "teas-8", name: "Глинтвейн красный", price: 500, image: productImage("глинтвейнкрасный.JPG") },
      { id: "teas-9", name: "Глинтвейн белый", price: 500, image: "/catalog/catalog2page.png" },
    ],
  },
  {
    id: "concentrates",
    ...
    defaultUnit: "л",
    products: [
      { id: "concentrates-1", name: "Малина концентрат", price: 550, image: productImage("малинамаракуйя.JPG") },
      { id: "concentrates-2", name: "Смородина концентрат", price: 550, image: productImage("смородинаразмарин.JPG") },
      { id: "concentrates-3", name: "Вишня концентрат", price: 550, image: productImage("вишнягранат.JPG") },
    ],
  },
  {
    id: "shots",
  ...
  },
  {
    ...
    defaultUnit: "л",
    products: [
      { id: "cold-brew-1", name: "Колд брю", price: 500, unit: "л", image: sticker("колдбрюсъемки") },
